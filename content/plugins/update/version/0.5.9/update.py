...
try:
    ...
    download_to_plugin("ban_pic/config")
    download_to_plugin("ban_pic/data")
    download_to_plugin("ban_word/__init__")
    download_to_plugin("auto_baned/tools")
    download_to_plugin("heweather/__init__")
    download_to_plugin("heweather/templates/weather", ".html")
