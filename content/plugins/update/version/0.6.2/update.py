...
try:
    ...
    download_to_plugin("memes/gif_subtitle_memes")
    download_to_plugin("memes/manager")
    ...
    download_to_resource("font/FZSEJW", True, ".ttf")
    download_to_resource("font/FZSJ-QINGCRJ", True, ".ttf")
    download_to_resource("font/FZXS14", True, ".ttf")
    download_to_resource("font/consola", True, ".ttf")

    # 新增部分
    mkd("content/plugins/petpet")
    ...
    download_to_plugin("petpet/manager")
