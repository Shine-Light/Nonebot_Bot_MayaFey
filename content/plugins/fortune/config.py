...
from utils.path import fortune_resource_path, font_path, fortune_path, fortune_copywriting_path
...
class PluginConfig(BaseModel, extra=Extra.ignore):
    fortune_path: Path = fortune_resource_path
...
async def fortune_check() -> None:
    ...
    '''
    copywriting_path: Path = fortune_copywriting_path
    ...
    '''
    fortune_data_path: Path = fortune_path / "fortune_data.json"
    fortune_setting_path: Path = fortune_path / "fortune_setting.json"
    group_rules_path: Path = fortune_path / "group_rules.json"
    specific_rules_path: Path = fortune_path / "specific_rules.json"
