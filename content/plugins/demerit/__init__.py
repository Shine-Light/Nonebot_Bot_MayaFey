...
__plugin_meta__ = PluginMetadata(
    ...
    extra={
        ...
        "permission_special": {
            "demerit:demerit": "superuser",
            "demerit:admin_get_demerit": "superuser",
            "demerit:set_demerit_config": "superuser"
        },
        "unset": False,
        "total_unable": False,
        "author": "Shine_Light",
...
matcherManager.addMatcher("demerit:demerit", demerit)
@demerit.handle()
...
matcherManager.addMatcher("demerit:admin_get_demerit", admin_get_demerit)
...
matcherManager.addMatcher("demerit:set_demerit_config", set_demerit_config)
